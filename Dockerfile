...
RUN cd /opt/geppetto && \
git clone https://github.com/VirtualFlyBrain/geppetto-vfb.git -b feature/react_refactoring && \
cd geppetto-vfb && git checkout feature/react_refactoring || true 
RUN cd /opt/geppetto && \
...
RUN cd /opt/geppetto && \
git clone https://github.com/VirtualFlyBrain/uk.ac.vfb.geppetto.git -b feature/react_refactoring && \
cd uk.ac.vfb.geppetto && git checkout feature/react_refactoring || true 
RUN cd /opt/geppetto && \
