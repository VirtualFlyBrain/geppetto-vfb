...
RUN apt-get -o Acquire::Check-Valid-Until=false update && curl -sL https://deb.nodesource.com/setup_11.x | sudo -E bash -
...
ENV BRANCH_ORG_GEPPETTO_DATASOURCES=$BRANCH_BASE
ENV BRANCH_ORG_GEPPETTO_SIMULATION=$BRANCH_BASE
ENV BRANCH_GEPPETTO_VFB=$BRANCH_DEFAULT
ENV BRANCH_UK_AC_VFB_GEPPETTO=release_march_2019
