...
class VFBTermInfo extends React.Component {
  ...
  renderButtonBar (anyInstance) {
    ...
    if (this.refs.termInfoInnerRef.clientWidth > 380) {
      $('#bar-div-vfbterminfowidget').css('padding-left', Math.floor((this.refs.termInfoInnerRef.clientWidth - 500) / 2) );
      $('#bar-div-vfbterminfowidget').css('padding-right', Math.floor((this.refs.termInfoInnerRef.clientWidth - 500) / 2) );  
    }
