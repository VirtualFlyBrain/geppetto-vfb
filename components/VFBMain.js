            ...
            xhr.onload = function () {
              try {
                if (this.responseXML.title.indexOf("404 Not Found") < 0) {
                  ...
                  if (document.getElementById('metaDesc') != undefined && this.responseXML.head != undefined && this.responseXML.head.getElementsByTagName('script') != undefined && this.responseXML.head.getElementsByTagName('script')[1] != undefined) {
