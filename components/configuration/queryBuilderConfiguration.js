...
var queryResultsColMeta = [
  ...
  },
  {
    ...
    "actions": "window.addVfbId('$entity$'.split('----')[0]); return false;",
    "displayName": "Name",
  ...
  },
  {
    ...
    "visible": true,
    "customComponent": QueryLinkComponent,
    "actions": "if ('$entity$'.split('----').length > 1) window.addVfbId('$entity$'.split('----')[1]); return false;",
  ...
  },
  {
    ...
    "visible": true,
    "customComponent": QueryLinkComponent,
    "actions": "if ('$entity$'.split('----').length > 2) window.addVfbId('$entity$'.split('----')[2]); return false;",
